...
class _PregnancySymptomsScreenState
  ...
  static const _commonSymptoms = [
    _SymptomDef(
      ...
      AppColors.symptomGreen,
    ),
    _SymptomDef('fatigue', 'Fatigue', Icons.bedtime_rounded, AppColors.symptomPurple),
    _SymptomDef(
      'back_pain',
      'Back Pain',
      Icons.accessibility_new_rounded,
      AppColors.symptomRed,
    ),
    _SymptomDef(
      'swelling',
      'Swelling',
      Icons.water_drop_rounded,
      AppColors.symptomBlue,
    ),
    _SymptomDef(
      'heartburn',
      'Heartburn',
    ...
    _SymptomDef(
      ...
      'Shortness of Breath',
      Icons.air_rounded,
      AppColors.symptomCyan,
    ),
    _SymptomDef(
      'frequent_urination',
      'Frequent Urination',
      Icons.water_rounded,
      AppColors.symptomSky,
    ),
  ];
  ...
  static const _warningSymptoms = [
    ...
    _SymptomDef(
      ...
      AppColors.periodVeryHeavy,
    ),
    _SymptomDef(
      'decreased_fetal_movement',
      'Decreased Fetal Movement',
      Icons.child_care_rounded,
      AppColors.symptomUrgent,
    ),
  ];
