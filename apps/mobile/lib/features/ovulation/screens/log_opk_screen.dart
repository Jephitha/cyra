    ...
    return Column(
      ...
      children: [
        ...
        _ResultOption(
          label: 'Positive',
          description:
              'Two lines — test line is as dark or darker than control',
          isSelected: _selectedResult == OPKResult.positive,
          selectedColor: AppColors.forestGreen,
          onTap: () => setState(() => _selectedResult = OPKResult.positive),
          isDark: isDark,
        ),
        ...
        _ResultOption(
          ...
          onTap: () => setState(() => _selectedResult = OPKResult.negative),
          isDark: isDark,
        ),
        const SizedBox(height: AppSpacing.sm),
        _ResultOption(
          ...
          onTap: () => setState(() => _selectedResult = OPKResult.fading),
          isDark: isDark,
        ),
      ],
    );
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                Text(
                  'Best time to test is between 10am and 2pm. Avoid testing with first morning urine. Reduce fluid intake 2 hours before testing.',
                  style: Theme.of(
                    context,
...
class _TestStripPainter extends CustomPainter {
  ...
  @override
  bool shouldRepaint(_TestStripPainter old) =>
      old.result != result || old.isSelected != isSelected;
}
