...
class _LogMucusScreenState extends ConsumerState<LogMucusScreen> {
  ...
  String get _educationalTip {
    ...
    return switch (_selectedType!) {
      CervicalMucusType.dry =>
        'Dry days are typically non-fertile. This is normal after menstruation and in the early follicular phase.',
      CervicalMucusType.sticky =>
        'Sticky mucus indicates estrogen is beginning to rise. Fertility is still low, but the fertile window is approaching.',
      CervicalMucusType.creamy =>
        'Creamy mucus is a transition type. Estrogen levels are increasing, and fertility is moderate. Watch for changes to egg white mucus.',
      CervicalMucusType.eggWhite =>
        'Egg white cervical mucus (EWCM) is the most fertile type. It helps sperm survive and travel. This is your peak fertility signal!',
      CervicalMucusType.watery =>
        'Watery mucus indicates high fertility. It allows sperm to pass through easily. You may be in or near your fertile window.',
    };
  }
  ...
  Widget _buildMucusOption(
    BuildContext context,
    _MucusTypeOption type,
    bool isDark,
  ) {
    final isSelected = _selectedType == type.type;
    final borderColor = type.isFertile
        ? AppColors.softGold
            ...
            children: [
              Container(
                ...
                child: Icon(
                  type.icon,
                  size: 24,
                  color: borderColor.withValues(alpha: isSelected ? 1 : 0.7),
                ),
              ),
      ...
      child: Row(
        ...
        children: [
          Icon(
            ...
            size: 20,
            color: _selectedOption!.isFertile
                ? AppColors.softGold
                : AppColors.forestGreen,
          ),
          const SizedBox(width: AppSpacing.md),
